const AppConstants = {
  ...
  // payments and card
  cardErrDefault: 'We could not process the payment, please check your payment details.',
  ...
  cancelDeRegOrTrValidationMsg: `Sorry we can't cancel the de-registration as it has already begun processing`,
  deRegistrationCancelledMsg: "De-Registration Cancelled",
  transferCancelledMsg: "Transfer Cancelled",

  //governmentvoucher transfergroup
  INSTALMENTFEE: 'INSTALMENT FEE',
  SCHOOLINVOICE: 'SCHOOL INVOICE',
  GOVERNMENTVOUCHER: 'GOVERNMENT VOUCHER',
  PERMATCH: 'PER MATCH',

  //empty payment intent
  EmptyPaymentIntent: 'PaymentIntentId is empty',

  //team de-registration 
  teamDeregistrationInProgress : 'Your team de-registration in progress. Please reach out your team manager.'
